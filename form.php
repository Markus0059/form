...
<form action="thanks.php" method="post" class="container bg-light border rounded p-5">
  ...
  <p class="row">
      ...
      <input type="email" name="user_mail" id="mail" class="form-control">
  </p>
  <p class="row">
      <label for="phone_number" class="form-label">Numéro de téléphone: </label>
      <input type="text" name="user_phone_number" id="phone_number" class="form-control">
  </p>
  <p class="row">
      <label for="sujets">Pour quel sujet vous nous contactez:</label>
      <select id="sujets" name="user_sujet" size="3">
  ...
  <p class="row">
      ...
      <textarea rows="10" cols="30" type="text" name="user_message" id="message" class="form-control"></textarea>
  </p>
